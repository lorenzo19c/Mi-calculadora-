 ...
 */
public class Mical extends javax.swing.JFrame {
...
switch (this.operador){
    ...
    case "-":this.casilla.setText(sincero(this.primernumero-this.segundonumero));break;
    case "*":this.casilla.setText(sincero(this.primernumero*this.segundonumero));break;
    case "/":if(this.segundonumero==0){ this.casilla.setText("No Se Divide En Cero");}
    else{
...
return retorno ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mical.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
